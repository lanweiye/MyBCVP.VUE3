<template>
    <el-form ref="loginFormRef" :model="loginForm" :rules="loginRules" size="large">
      <el-form-item prop="name">
        <el-input v-model="loginForm.name" placeholder="用户名：blogadmin">
          <template #prefix>
      ...
      <el-form-item prop="pass">
        <el-input v-model="loginForm.pass" type="pass" placeholder="密码：blogadmin" show-password autocomplete="new-password">
          <template #prefix>
            <el-icon class="el-input__icon">
              <lock />
            </el-icon>
    ...
    <div class="login-btn">
      ...
      <el-button :icon="UserFilled" round size="large" type="primary" :loading="loading" @click="loginModule(loginFormRef)">
        登录
      </el-button>
    </div>
  </template>
